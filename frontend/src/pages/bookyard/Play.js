...
const Play = () => {
  ...
  }, [location.search, userObject?.USER_SEQ, lastPosition,  location.state.selected]);
  ...
  <Button
    ...
    sx={{
      ...
      "&:hover": {
        ...
        color: "#FFFFFF",
        "& .hover-text": { // 내부 Box 요소에 hover 효과 적용
          color: "#FFFFFF",
        },
      },
      display: "flex",
  ...
  <Button
    ...
    sx={{
      ...
      "&:hover": {
        backgroundColor: "#246624",
        color: "#FFFFFF",
        "& .hover-text": { // hover 시 내부 텍스트를 흰색으로
          color: "#FFFFFF",
        },
      },
      display: "flex",
  ...
  <Button
    ...
    sx={{
      ...
      "&:hover": {
        backgroundColor: "#246624",
        color: "#FFFFFF",
        "& .hover-text": { // hover 시 모든 텍스트를 흰색으로
          color: "#FFFFFF",
        },
      },
      display: "flex",
