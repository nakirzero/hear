...
import { checkUserId, joinSubmit } from "../api/user";
...
function Join() {
  ...
  const handleJoin = async (e) => {
    ...
    try {
      ...
      console.log(message ? "회원가입을 완료하였습니다." : "회원가입에 실패하였습니다.");
    } catch {
      ...
      <form onSubmit={handleJoin}>
        <Box sx={{ width: "100%", maxWidth: 600, padding: 3 }}>
          <Grid container spacing={2} alignItems="center">
            ...
            <Grid item xs={7}>
              <TextField fullWidth name="userId" onChange={handleJoinInput} value={formData.userId} />
            </Grid>
            ...
            <Grid item xs={7}>
              <TextField fullWidth type="password" name="pw" onChange={handleJoinInput} value={formData.pw} />
            </Grid>
            ...
            <Grid item xs={7}>
              <TextField fullWidth type="password" name="pwok" onChange={handleJoinInput} value={formData.pwok} />
            </Grid>
            ...
            <Grid item xs={7}>
              <TextField fullWidth name="disabled" onChange={handleJoinInput} value={formData.disabled} />
            </Grid>
          </Grid>
